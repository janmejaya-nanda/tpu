...
def main(unused_argv):
    ...
    assert len(FLAGS.input_image_size.split(',')) == 2, "Wrong input_image_size format"
    width, height = map(int, FLAGS.input_image_size.split(','))
    # Load the label map.
...
if __name__ == '__main__':
    ...
    flags.mark_flag_as_required('input_image_size')
